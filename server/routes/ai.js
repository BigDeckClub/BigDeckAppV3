 ...
 */
router.get('/ai/inventory/:userId', authenticateApiKey, async (req, res) => {
 ...
 */
router.post('/ai/deck', authenticateApiKey, validateBody(createAIDeckSchema), async (req, res) => {
 ...
 */
router.post('/ai/prices', authenticateApiKey, validateBody(batchPricesSchema), async (req, res) => {
 ...
 */
router.get('/ai/user/:userId', authenticateApiKey, async (req, res) => {
  const { userId } = req.params;
