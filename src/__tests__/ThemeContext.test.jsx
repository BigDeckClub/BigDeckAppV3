...
describe('ThemeContext', () => {
  ...
  test('persists theme to localStorage', () => {
    ...
    expect(localStorage.getItem('bigdeck-theme')).toBe('parchment');
    expect(localStorage.getItem('theme')).toBe('parchment');
  });
  ...
  test('preserves backward compatibility with legacy storage key', () => {
    ...
    const btn = getByText('toggle');
    expect(btn.getAttribute('data-theme')).toBe('parchment');
  });
});
