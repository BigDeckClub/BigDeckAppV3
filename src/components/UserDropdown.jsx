...
export function UserDropdown({ setActiveTab, activeTab, direction = 'down', isCollapsed = false }) {
    ...
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className={`
          ...
          bg-[var(--bda-surface)] hover:bg-[var(--bda-primary)] 
          transition-all duration-300 text-[var(--bda-muted)] hover:text-[var(--bda-primary-foreground)] 
          shadow-md border border-[var(--bda-border)]
      ...
      >
        ...
        {!isCollapsed && (
          <span className="font-medium text-sm truncate animate-fade-in text-left flex-1">
            {user?.email?.split('@')[0]}
          </span>
        )}
      </button>
