          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-8 md:p-10 shadow-2xl space-y-6">
              ...
              <button
                ...
                className="w-full btn-primary py-4 px-6 font-semibold flex items-center justify-center gap-3 text-lg rounded-xl shadow-lg shadow-teal-500/25 hover:shadow-xl hover:shadow-teal-500/50 transition-all duration-300 hover:scale-105 active:scale-95"
              >
